...
public:
    ...
    Node(std::string name = "",
        ...
        int final_value = INF,
        std::vector<Node> connections = std::vector<Node>()) 
    {
        this->name = name;
        this->order = order;
    ...
    // enables <=> operator, and the compiler auto-generates == and !=
    ...
    void set_connections(std::vector<Node> c) { this->connections = c; };
    ...
    inline std::vector<Node> get_connections() { return this->connections; };
